...
class Config:
    ...
    ENABLE_LAZY_LOADING = True  # Enable/disable lazy loading
    MAX_CONCURRENT_LOADS = 5    # Maximum concurrent card data loads
    MAX_CONCURRENT_IMAGES = 3   # Maximum concurrent image loads
    PRELOAD_VISIBLE_CARDS = True # Preload data for visible cards
    PRELOAD_IMAGES_ON_DEMAND = True # Only load images when requested
