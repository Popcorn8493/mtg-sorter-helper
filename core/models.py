...
class Card:
    ...
    def from_scryfall_dict(cls, data: Dict[str, Any]) -> 'Card':
        ...
        return cls(scryfall_id=data.get('id', ''), name=data.get('name', 'N/A'), set_name=data.get('set_name', 'N/A'), rarity=data.get('rarity', 'N/A'), type_line=data.get('type_line', 'N/A'), color_identity=data.get('color_identity', []), edhrec_rank=data.get('edhrec_rank'), image_uri=image_uris.get('normal') if image_uris else None, mana_cost=mana_cost, prices=data.get('prices', {}))
